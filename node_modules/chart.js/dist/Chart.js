...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		? (module.exports = factory(
				(function () {
					try {
						return require('chart.js/dist/node_modules/chart.js/dist/node_modules/moment');
					} catch (e) {}
				})()
			))
 ...
 */
	 ...
	 */
		merge                 : function (target, source, options) {
			var sources = helpers.isArray(source)
				? source
				: [
						source
					];
		...
		calculateBarValuePixels    : function (datasetIndex, index, options) {
			...
			var length =
				value.start === undefined
					? value.end
					: value.max >= 0 && value.min >= 0 ? value.max - value.min : value.min - value.max;
			var ilen = metasets.length;
					...
					if (imeta.stack === stack) {
						...
						ivalue =
							stackLength.start === undefined
								? stackLength.end
								: stackLength.min >= 0 && stackLength.max >= 0 ? stackLength.max : stackLength.min;
 ...
 */
	...
	function getAlignedX (vm, align) {
		return align === 'center'
			? vm.x + vm.width / 2
			: align === 'right' ? vm.x + vm.width - vm.xPadding : vm.x + vm.xPadding;
	}
	...
	*/
	 ...
	 */
			updateDataset                 : function (index) {
				...
				core_plugins.notify(me, 'afterDatasetUpdate', [
					args
				]);
			},
			...
			draw                          : function (easingValue) {
				...
				if (
					core_plugins.notify(me, 'beforeDraw', [
						easingValue
					]) === false
				) {
					return;
	 ...
	 */
			drawDataset                   : function (meta, easingValue) {
				...
				if (
					core_plugins.notify(me, 'beforeDatasetDraw', [
						args
					]) === false
				) {
					return;
				...
				core_plugins.notify(me, 'afterDatasetDraw', [
					args
				]);
			},
	 ...
	 */
			_drawTooltip                  : function (easingValue) {
				...
				if (
					core_plugins.notify(me, 'beforeTooltipDraw', [
						args
					]) === false
				) {
					return;
				...
				core_plugins.notify(me, 'afterTooltipDraw', [
					args
				]);
			},
	 ...
	 */
			eventHandler                  : function (e) {
				...
				if (
					core_plugins.notify(me, 'beforeEvent', [
						e
					]) === false
				) {
					return;
				...
				core_plugins.notify(me, 'afterEvent', [
					e
				]);
	...
	*/
	 ...
	 */
		...
		afterSetDimensions          : function () {
			helpers$1.callback(this.options.afterSetDimensions, [
				this
			]);
		},
		...
		afterDataLimits             : function () {
			helpers$1.callback(this.options.afterDataLimits, [
				this
			]);
		},
		...
		beforeBuildTicks            : function () {
			helpers$1.callback(this.options.beforeBuildTicks, [
				this
			]);
		},
	 ...
	 */
		_getMatchingVisibleMetas    : function (type) {
			...
			return me.chart._getSortedVisibleDatasetMetas().filter(function (meta) {
				return (
					(!type || meta.type === type) && (isHorizontal ? meta.xAxisID === me.id : meta.yAxisID === me.id)
				);
			});
		}
	});
